...
class PPOTrainer(Trainer):
    ...
    def __init__(self, sess, env, brain_name, trainer_parameters, training, seed,eternalLearning):
        """
        ...
        super(PPOTrainer, self).__init__(sess, env, brain_name, trainer_parameters, training,eternalLearning)
